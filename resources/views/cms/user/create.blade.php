        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-12 page-content-area ">
                <div class="inner-content">
                    <form action="{{ route('cms.user.create') }}" method="post" class="modal-body col-12" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="mb-4">
                                <div class="row d-flex flex-wrap">
                                    ...
                                    <div class="col-12 col-md-6 p-0 m-0">
                                        ...
                                        <div class="col col-12 col-lg-12 mt-2">
                                            <input class="form-control w-100" name="password" id="password" type="password" value="{{ old('password') }}">
